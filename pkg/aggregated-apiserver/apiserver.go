...
import (
	...
	coreinstall "github.com/kubewharf/kubeadmiral/pkg/apis/core/install"
	...
	storage "github.com/kubewharf/kubeadmiral/pkg/registry/aggregated-apiserver/aggregation/cluster"
...
func (c completedConfig) New(restConfig *restclient.Config) (*Server, error) {
	...
	clusterStorage, err := storage.NewStorage(Scheme, restConfig, c.GenericConfig.RESTOptionsGetter)
	if err != nil {
	...
	v1alpha1storage["federatedclusters"] = clusterStorage.Cluster
	v1alpha1storage["federatedclusters/status"] = clusterStorage.Status
	v1alpha1storage["federatedclusters/proxy"] = clusterStorage.Proxy
